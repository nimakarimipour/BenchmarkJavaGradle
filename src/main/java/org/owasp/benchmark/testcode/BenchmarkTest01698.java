  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    String param =
        queryString.substring(
            paramLoc + paramval.length()); // 1st assume "BenchmarkTest01698" param is last
    ...
    try {
      ...
      @RUntainted String rememberMeKey = Double.toString(rand).substring(2); // Trim off the 0. at the front.
          ...
          new String(
              org.apache.commons.codec.binary.Base64.decodeBase64(
                  org.apache.commons.codec.binary.Base64.encodeBase64(
                      d72232.getBytes()))); // B64 encode and decode it
